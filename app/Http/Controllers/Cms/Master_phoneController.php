...
class Master_phoneController extends Controller
{
    ...
    function edit($id)
    {
    	...
    	return  view('pages/cms/master_phone/master_phone_edit')
    	->with('dms_master_phone',$dms_master_phone);
    }
    ...
    function insert (Request $request)  
    {
        ...
        $dms_master_phone = new Master_phone;
            ...
            $dms_master_phone->created_by = session()->get('session_name_cms'); 
    ...
    function update (Request $request, $id)  
    {
    	...
    	$dms_master_phone = Master_phone::find($id);
    		...
    		// nama = nama field di database, var_nama = var_nama di dalam form input_blade
            $dms_master_phone->driver_phone = $request->driver_phone; 
            $dms_master_phone->updated_by = session()->get('session_name_cms') ;
    	// untuk mengsave
    	$dms_master_phone->save();
