<div class="container ">
    <div class="navbar-header ">
      <a class="logos" href="/dhlcms/public/cms/dashboard" id="menu-home"><img src="{{ asset('image/logo.png')}}" class="imagestyle"></a>
    </div>
    ...
    <ul class="nav navbar-nav navbar-right rightbar">
      ...
      <a href="/dhlcms/public/cms/logout" class="logout" onclick="
