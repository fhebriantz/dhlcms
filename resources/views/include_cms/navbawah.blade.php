<div class="container">
    <ul class="nav nav-tabs navbottom navcms">
      <li class="nav-item"><a class="active nav-link"  href="/dhlcms/public/cms/dashboard"><span class="ion-android-desktop"></span> Home</a>
      </li>
      <li class="dropdown nav-item"><a class="dropdown-toggle  active nav-link" data-toggle="dropdown" href="#"><span class="ion-ios-settings-strong"></span> Master</a>
        <ul class="dropdown-menu">
          ...
          <li><a href="/dhlcms/public/cms/master_vehicle">Master Vehicle</a></li>
        </ul>
      </li>
      <li class="dropdown nav-item"><a class="dropdown-toggle  active nav-link" data-toggle="dropdown" href="#"><span class="ion-android-person"></span> User</a>
        <ul class="dropdown-menu">
           <li><a href="/dhlcms/public/cms/user_management">User</a></li>
           <li><a href="/dhlcms/public/cms/user_group">User Group</a></li>
        </ul>
      </li>
    </ul>
  </div>