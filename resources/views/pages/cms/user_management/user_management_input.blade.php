...
@section('content')
    <div class="tab-pane active">
      ...
      <div class="col-md-6 col-sm-12">
        ...
        @endif
        <form method="POST" action="/dhlcms/public/cms/user_management/input">
            {{ csrf_field() }}
            ...
            <input type="password" class="form-text" name="passwordconfirm" placeholder="Confirm Password" value="{{ old('passwordconfirm') }}" autocomplete="off">
            <table width="100%">
            <tr class="form-text">
              <td>User Group</td>
