...
@section('content')
    <div class="tab-pane active">
      <div class="col-sm-12">
        <div class="row ujung">
          <div class="col-sm-12 paddinghead" style="background-color: #eee">
            <h5 style="color: #d71635"><strong>Master Project > Input</strong></h5>
          </div>  
        </div>
      ...
      <div class="col-md-6 col-sm-12">
        ...
        @endif
        <form method="POST" action="/dhlcms/public/cms/master_project/input">
            {{ csrf_field() }}
            <input type="text" class="form-text" name="master_project_name" placeholder="Driver Name" value="{{ old('caption') }}">
            <div class="row">
