...
@section('content')
      <div class="">
        <div class="col-sm-12">
          ...
          <a href="/dhlcms/public/cms/user_group/input"><button type="button" style="margin-bottom: 10px;" class="btn btnadd">Add Data</button></a>
        </div>
        <div>
        <table class="table table-striped fontsizetable text-center"  width="100%" cellspacing="0">     
          ...
          <tbody class="paddingtable text-center">
            ...
            <tr>    
              ...
              <td style="float: left;">
                <a href="/dhlcms/public/cms/user_group/{{ $group->id }}/edit"><button type="button" class="action btn btn-danger"><img src="{{ asset('image/pencil.png')}}" alt="" style="width: 16px; height: auto; "></button></a>
                <form method="POST" action="/dhlcms/public/cms/user_group/{{ $group->id }}/delete" class="text-center" style="float: right; margin-left: 2px;">
                  {{ csrf_field() }}
